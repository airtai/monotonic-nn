...
def _generate_api_docs_for_module(root_path: Path, module_name: str) -> str:
    ...
    src = """                    - [ContactDict](api/airt/asyncapi/schema/info/ContactDict.md)
"""
    dst = """                    - [ContactDict](api/airt/asyncapi/schema/info/ContactDict.md)
                    - [EmailStr](api/airt/asyncapi/schema/info/EmailStr.md)
"""
